...
### Example: Abraham
**Consider the moral problems raised by the biblical story of Abraham. Common to all 3 Religions of Abraham**  <!-- .element: style="float: right; width: 30%" -->

![](http://drive.google.com/uc?id=0B8ezT0-tUjVZbDZ6S3RGTmgtakE) <!-- .element: style="width: 50%" -->
